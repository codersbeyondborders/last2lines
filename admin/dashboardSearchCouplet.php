...
/*** Search Author **/
$authorOutput='';
if (isset($_POST['searchEntrySubmit'])) {
		$emailToSearch = null;
		$emailFlag = false;
		$searchMessage = "";
		
		if(isset($_POST['emailToSearch']))
		$emailToSearch = mysql_prep($_POST['emailToSearch']);
	...
	if($emailFlag){
			//success
				//$authors_result_set  = get_author_by_email($emailToSearch);
			
			if(checkEmail($emailToSearch))
			$authors_result_set  = get_author_by_email($emailToSearch);
...
$authorOutput .='</tbody>
			...
			$searchMessage = "No such email registered!!";
		}
}else{
	$searchMessage = "Email field is required!!";
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
					<br/>
					<h2>Search Existing Couplet</h2>
					<hr/>
					
					<!--Search Author by Email-->
						<?php if (!empty($searchMessage)) {echo "<br/><p class=\"text-danger\">" . $searchMessage . "</p>";} ?>
						
						<form class="Compose-Message"
						action="dashboardSearchCouplet.php" method="post"
						>
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="text" name="emailToSearch"class="form-control" />
                                    
									
                                    <hr />
                                    <input  type="submit" name="searchEntrySubmit" value="submit" class="btn btn-info"/>
                                </div>
                                
                            </div>
                        </form>
                        <!-- Search Email by Author-->
